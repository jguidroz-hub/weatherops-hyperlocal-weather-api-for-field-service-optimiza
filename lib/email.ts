...
const FROM = process.env.EMAIL_FROM || 'WeatherOps - Hyperlocal weather API for field service optimization <noreply@example.com>';
const APP_NAME = 'WeatherOps - Hyperlocal weather API for field service optimization';

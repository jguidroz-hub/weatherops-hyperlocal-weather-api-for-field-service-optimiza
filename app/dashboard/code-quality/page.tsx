...
export default function FeaturePage() {
  const items = [
    { t: "Test Coverage: 73%", d: "↑ 5% this sprint • Target: 80% • 234 tests passing, 3 failing", s: "improving" },
    { t: "Tech Debt Score: 24 hours", d: "↓ 8 hours this month • Top: unused imports (6h), dead code (4h)", s: "improving" },
    { t: "Cyclomatic Complexity: 8.2 avg", d: "3 functions above threshold (>15) • Refactor candidates flagged", s: "warning" },
    { t: "Dependency Freshness: 89%", d: "4 packages outdated • 1 has known vulnerability", s: "action" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Code Quality</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Track code quality metrics across your codebase</p>
